...
<style type="text/css">
.raj{
background-image : linear-gradient(to bottom right, cyan, grey);
...
<body>
	...
	%>
	<div class="header">
		<nav class="navbar navbar-expand-lg raj fixed-top" >
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown"
					style="padding-left: 5px; padding-right:42px">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.LOGIN_CTL%>"><i
							class="fas fa-sign-in-alt"></i>Login</a>
							 <a class="dropdown-item" href="<%=ORSView.USER_REGISTRATION_CTL%>"><i
